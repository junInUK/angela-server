...
This article only deploys the backend Node.js + MongoDB to Heroku. If you have a front end app, please see [How to deploy your vue project to Netlify](https://github.com/junwu1976/angela-client/blob/master/Netlify_deploy.md).
